...
use Modules\Exercise\Http\Controllers\user\LastedUpcomingliftingController;
...
Route::middleware(['check.user.details'])->group(function () {
    ...
    Route::prefix('sets')->group(function () {
        ...
        Route::get('/getLastAndUpcoming', [LastedUpcomingliftingController::class, 'getLastAndUpcoming']);
    });
});
