...
class UpdateStateRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'required|integer|exists:states,id', // Ensures 'id' is a valid state ID
            ...
            'country_id' => 'required|integer|exists:countries,id', // 'country_id' must be a valid country ID
        ];
    }
